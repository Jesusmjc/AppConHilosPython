...
def task2():
    ...
    print("ID del hilo correindo la tarea 2: {}".format(threading.current_thread().ident))


if __name__ == "__main__":
    print("ID del proceso corriendo el programa main: {}".format(threading.current_thread().name))
